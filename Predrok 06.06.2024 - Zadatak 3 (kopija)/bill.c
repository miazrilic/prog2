/*
Funkcija readBuyerSeller() čita posebno prodavača i kupca iz datoteke. Za argumente prima tok podataka datoteke iz koje čita informacije i prima memorijsku adresu računa.
...
Funkcija readItems() dinamički zauzima polje artikala, čita imena artikala kao i njihovu cijenu i količinu. Na kraju funkcije poziva se funkcija addBillItem(). 
Funkcija za argumente prima tok podataka datoteke iz koje čita informacije i prima memorijsku adresu računa. Funkcija ništa ne vraća.
